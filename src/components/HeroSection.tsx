...
const HeroSection = () => (
  <section id="home" className="relative min-h-0 md:min-h-[calc(100vh-72px)] flex items-center pt-2 md:pt-16 pb-8 md:pb-16 overflow-hidden">
    {/* Background effects — lightweight, no blur on mobile */}
    <div className="absolute inset-0 bg-dot-grid opacity-40 pointer-events-none" />
    <div className="absolute inset-0 pointer-events-none" style={{ background: "var(--gradient-hero)" }} />
    {/* Desktop-only decorative orbs (hidden on mobile via CSS) */}
    ...
    <div className="container mx-auto px-4 lg:px-8 relative z-10">
      ...
      {/* Dashboard mockup — CSS fade-in, no framer-motion */}
        ...
        <div className="relative glass-card rounded-2xl border border-border/60 overflow-hidden shadow-2xl">
          ...
          <div className="flex min-h-[380px] lg:min-h-[420px]">
            ...
            <div className="flex-1 p-5 space-y-4 overflow-hidden">
              ...
              {/* Charts — static bars, no framer-motion */}
