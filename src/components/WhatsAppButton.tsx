...
export const WhatsAppFloatingButton = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-center gap-3">
      {hovered && (
        <div
          className="hidden sm:block px-4 py-2 rounded-xl bg-card border border-border/40 shadow-lg text-sm font-medium text-foreground whitespace-nowrap animate-fade-in-right"
        >
          Hablar por WhatsApp
        </div>
      )}
      ...
      <a
        ...
        className="flex items-center justify-center w-16 h-16 rounded-full bg-[#25D366] shadow-[0_4px_20px_rgba(37,211,102,0.35)] hover:shadow-[0_6px_28px_rgba(37,211,102,0.5)] hover:scale-[1.08] active:scale-95 transition-all duration-300"
