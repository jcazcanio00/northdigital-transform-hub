...
export const WhatsAppFloatingButton = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-center gap-3">
      {hovered && (
        <div
          className="hidden sm:block px-4 py-2 rounded-xl bg-card border border-border/40 shadow-lg text-sm font-medium text-foreground whitespace-nowrap animate-fade-in"
        >
          Hablar por WhatsApp
        </div>
      )}
