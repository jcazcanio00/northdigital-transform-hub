...
const steps = [
  { icon: Search, title: "Descubrimiento", desc: "Analizamos tus procesos, necesidades y objetivos para diseñar la mejor solución." },
          ...
          {steps.map((step, i) => (
            ...
            >
              ...
              <div className="relative z-10 shrink-0">
                <div className="w-16 h-16 rounded-2xl bg-primary/10 border border-primary/20 flex items-center justify-center shadow-[0_0_30px_-8px_hsl(var(--primary)/0.3)]">
