...
const TestimonialCard = ({ t }: { t: typeof testimonials[0] }) => (
  <div className="w-[340px] shrink-0 rounded-2xl p-6 mx-3 bg-gradient-to-br from-[hsl(220,50%,14%)] to-[hsl(228,45%,10%)] border border-white/10 shadow-lg hover:-translate-y-1 transition-all duration-500">
