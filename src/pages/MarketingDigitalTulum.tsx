...
/* ─── Data ─── */
const channels = [
  { icon: Search, title: "SEO Estratégico Local", desc: "Posicionamiento orgánico en Google para búsquedas de alto valor en Tulum y la Riviera Maya. Dominamos las SERPs locales para hoteles boutique, wellness brands y negocios premium.", tag: "Orgánico" },
  { icon: Target, title: "Google Ads & SEM", desc: "Campañas de búsqueda, display y performance max orientadas al mercado de Tulum con optimización de bidding y audiencias de turismo internacional.", tag: "Paid" },
  { icon: Layers, title: "Landing Pages de Alto Impacto", desc: "Páginas de conversión diseñadas con frameworks CRO, A/B testing y personalización para cada segmento de audiencia en Tulum y alrededores.", tag: "Conversión" },
  ...
  { icon: MousePointerClick, title: "CRO & Experimentación", desc: "Programa de experimentación con heatmaps, session recordings, tests A/B multivariados y análisis de embudo para negocios en Tulum.", tag: "Optimización" },
  { icon: Mail, title: "Email & Marketing Automation", desc: "Secuencias de nurturing, lead scoring, segmentación predictiva y workflows que aceleran el pipeline de ventas para marcas premium.", tag: "Automation" },
];

const frameworkSteps = [
  { icon: Megaphone, title: "Adquisición", desc: "SEO local, SEM y canales pagados para captar tráfico cualificado en Tulum y la Riviera Maya.", color: "text-blue-500", metric: "84K visits/mo" },
...
const metrics = [
  { icon: DollarSign, title: "ROAS", desc: "Cada peso invertido en pauta genera un retorno medible y optimizado mes a mes para negocios premium en Tulum y la Riviera Maya.", value: "5.2x", sub: "promedio" },
  { icon: Percent, title: "Tasa de conversión", desc: "Optimización continua de landing pages y embudos para maximizar cada visita de turistas y clientes potenciales en Tulum.", value: "4.8%", sub: "avg. CVR" },
  ...
  { icon: Users, title: "Coste por Lead", desc: "Reducción progresiva del CAC mediante optimización de audiencias internacionales y bidding en Tulum.", value: "-34%", sub: "reducción" },
  { icon: TrendingUp, title: "Tráfico orgánico", desc: "Crecimiento sostenido de visitas orgánicas para hoteles boutique, wellness brands y servicios premium en Tulum.", value: "+120%", sub: "YoY growth" },
...
const useCases = [
  { icon: Globe, title: "Hoteles Boutique & Wellness", desc: "Marketing digital especializado para hoteles boutique, eco-lodges y centros de wellness en Tulum. SEO internacional, Google Ads y estrategias de temporada para atraer viajeros premium." },
  { icon: ShoppingCart, title: "Restaurantes & Gastronomía", desc: "Estrategias de visibilidad local para restaurantes en la zona hotelera y pueblo de Tulum. Google Business, redes sociales y campañas de temporada alta." },
  { icon: FileText, title: "Bienes Raíces Premium", desc: "Lead generation para desarrolladoras y agencias inmobiliarias en Tulum con campañas de alta intención dirigidas a compradores nacionales e internacionales." },
  { icon: Users, title: "Lifestyle & Wellness Brands", desc: "SEO, Google Ads y landing pages para marcas de bienestar, yoga, retiros y experiencias holísticas que definen la identidad de Tulum." },
  { icon: PieChart, title: "Turismo & Experiencias", desc: "Marketing digital para tours, cenotes, experiencias culturales y aventura en Tulum. Estrategias multilingües para audiencias internacionales." },
  { icon: BarChart3, title: "Comercio & Retail Premium", desc: "Estrategias de marketing digital para boutiques, concept stores y marcas artesanales con presencia en Tulum y la Riviera Maya." },
];

const localAreas = [
  { name: "Tulum", desc: "Agencia de marketing digital en Tulum enfocada en crecimiento para hoteles boutique, wellness brands, restaurantes y negocios premium en la zona hotelera, pueblo y alrededores." },
  ...
  { name: "Cancún", desc: "Estrategias digitales para negocios en Cancún. SEO, campañas pagadas y presencia digital para empresas en la zona hotelera, centro y Puerto Cancún." },
...
const faqs = [
  {
    q: "¿Ofrecen servicios de marketing digital en Tulum?",
    a: "Sí. Somos una agencia de marketing digital con amplia experiencia en Tulum. Diseñamos estrategias de SEO local e internacional, Google Ads, automatización de leads y analítica avanzada adaptadas al mercado de hoteles boutique, wellness y turismo premium.",
  },
  {
    q: "¿Qué incluye el servicio de marketing digital en Tulum?",
    a: "Nuestro servicio incluye SEO técnico y local, campañas de Google Ads, landing pages de conversión, email marketing, analítica avanzada con GA4 y CRO. Todo orientado a generar reservas, leads cualificados y escalar ingresos para negocios en Tulum.",
  },
  {
    q: "¿Trabajan con hoteles boutique y marcas de wellness en Tulum?",
    a: "Absolutamente. Tenemos experiencia con hoteles boutique, eco-lodges, centros de wellness, retiros y marcas lifestyle en Tulum. Diseñamos estrategias que conectan con audiencias internacionales premium durante todo el año.",
  },
  {
    q: "¿También cubren Cancún y Playa del Carmen?",
    a: "Sí. Brindamos cobertura de marketing digital en toda la Riviera Maya: Tulum, Playa del Carmen, Cancún, Puerto Morelos, Akumal y Puerto Aventuras. Adaptamos cada estrategia al mercado y la audiencia de cada zona.",
  },
  {
...
const jsonLd = [
  ...
  },
  {
    "@context": "https://schema.org",
    "@type": "LocalBusiness",
    "name": "North Digital - Agencia de Marketing Digital en Tulum",
...
/* ─── Main Page ─── */
const MarketingDigitalTulumPage = () => {
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          <motion.div {...fade()} className="text-center mb-14">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold font-display mb-4">
              Servicios de Marketing <span className="gradient-text">Digital en Tulum</span>
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Cada canal está diseñado para generar tráfico cualificado, reservas y revenue medible para hoteles boutique, wellness brands y negocios premium en Tulum y la Riviera Maya.
            </p>
          </motion.div>
          ...
          {/* Cross-linking to other local pages */}
          <motion.div {...fade(0.4)} className="mt-4 text-center">
            <div className="flex flex-wrap justify-center gap-3">
              <Link to="/marketing-digital-cancun" className="text-sm text-muted-foreground hover:text-primary underline underline-offset-4 transition-colors">
                Marketing digital en Cancún
              </Link>
              <span className="text-muted-foreground/30">·</span>
              <Link to="/marketing-digital-playa-del-carmen" className="text-sm text-muted-foreground hover:text-primary underline underline-offset-4 transition-colors">
                Marketing digital en Playa del Carmen
              </Link>
            </div>
          </motion.div>
        </div>
      ...
      <section className="py-24 surface-sunken relative">
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          <motion.div {...fade()} className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Un sistema probado de cuatro fases para escalar negocios en Tulum, Playa del Carmen y la Riviera Maya.
            </p>
          </motion.div>
      ...
      <section className="py-14 relative overflow-hidden border-y border-border/10">
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10 mb-6">
          <p className="text-center text-[10px] text-muted-foreground tracking-[0.25em] uppercase font-medium">
            Tecnologías y plataformas que utilizamos para marketing digital en Tulum y Riviera Maya
          </p>
        </div>
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10 text-center max-w-3xl">
          <motion.div {...fade()}>
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold font-display mb-6 text-white leading-tight">
              ...
              <span className="gradient-text">en Tulum</span>
            </h2>
            <p className="text-base sm:text-lg text-white/50 mb-10 max-w-xl mx-auto leading-relaxed">
              Combinamos conocimiento del mercado local con estrategias de clase mundial para posicionar tu hotel boutique, wellness brand o negocio premium en Tulum y la Riviera Maya.
            </p>
      ...
      <section className="py-24 relative">
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          <motion.div {...fade()} className="text-center mb-14">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold font-display mb-4">
              Métricas que <span className="gradient-text">optimizamos</span> en Tulum
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Nos enfocamos en los indicadores que realmente impactan el crecimiento y la rentabilidad de tu negocio en Tulum y la Riviera Maya.
            </p>
          </motion.div>
      ...
      <section className="py-24 surface-sunken relative">
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          <motion.div {...fade()} className="text-center mb-14">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold font-display mb-4">
              Marketing digital para <span className="gradient-text">tu industria en Tulum</span>
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Estrategias de marketing digital especializadas para hoteles boutique, wellness brands y negocios premium en Tulum y la Riviera Maya.
            </p>
          </motion.div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {useCases.map((u, i) => (
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10 max-w-3xl">
          <motion.div {...fade()} className="text-center mb-12">
            ...
            <h2 className="text-2xl sm:text-3xl font-extrabold font-display mb-3">
              ...
              <span className="gradient-text">Tulum</span>
            </h2>
          </motion.div>
          <motion.div {...fade(0.1)}>
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10 text-center max-w-3xl">
          <motion.div {...fade()}>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold font-display mb-6 text-white">
              Escala tu negocio en Tulum con{" "}
              <span className="gradient-text">marketing digital</span>
            </h2>
            <p className="text-lg text-white/60 mb-10 max-w-xl mx-auto">
              La agencia de marketing digital en Tulum y Riviera Maya que combina datos, tecnología y creatividad para posicionar tu marca ante audiencias internacionales.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <Button variant="gradient" size="lg" asChild>
...
export default MarketingDigitalTulumPage;
