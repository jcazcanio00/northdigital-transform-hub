...
/* ─── Data ─── */
const channels = [
  { icon: Search, title: "SEO Estratégico Local", desc: "Posicionamiento orgánico en Google para búsquedas de alto valor en Playa del Carmen, Quinta Avenida y la Riviera Maya. Dominamos las SERPs locales con arquitectura técnica avanzada.", tag: "Orgánico" },
  { icon: Target, title: "Google Ads & SEM", desc: "Campañas de búsqueda, display y performance max orientadas al mercado de Playa del Carmen y la Riviera Maya con optimización de bidding y audiencias locales.", tag: "Paid" },
  { icon: Layers, title: "Landing Pages de Alto Impacto", desc: "Páginas de conversión diseñadas con frameworks CRO, A/B testing y personalización para cada segmento de audiencia en Playa del Carmen y alrededores.", tag: "Conversión" },
  ...
  { icon: MousePointerClick, title: "CRO & Experimentación", desc: "Programa de experimentación con heatmaps, session recordings, tests A/B multivariados y análisis de embudo para negocios en Playa del Carmen.", tag: "Optimización" },
  { icon: Mail, title: "Email & Marketing Automation", desc: "Secuencias de nurturing, lead scoring, segmentación predictiva y workflows que aceleran el pipeline de ventas para empresas locales.", tag: "Automation" },
];

const frameworkSteps = [
  { icon: Megaphone, title: "Adquisición", desc: "SEO local, SEM y canales pagados para captar tráfico cualificado en Playa del Carmen y la Riviera Maya.", color: "text-blue-500", metric: "84K visits/mo" },
...
const metrics = [
  { icon: DollarSign, title: "ROAS", desc: "Cada peso invertido en pauta genera un retorno medible y optimizado mes a mes para negocios en Playa del Carmen y la Riviera Maya.", value: "5.2x", sub: "promedio" },
  { icon: Percent, title: "Tasa de conversión", desc: "Optimización continua de landing pages y embudos para maximizar cada visita de usuarios en Playa del Carmen.", value: "4.8%", sub: "avg. CVR" },
  ...
  { icon: Users, title: "Coste por Lead", desc: "Reducción progresiva del CAC mediante optimización de audiencias y bidding en Playa del Carmen y Quintana Roo.", value: "-34%", sub: "reducción" },
  { icon: TrendingUp, title: "Tráfico orgánico", desc: "Crecimiento sostenido de visitas orgánicas para empresas en Playa del Carmen, Tulum y la Riviera Maya.", value: "+120%", sub: "YoY growth" },
...
const useCases = [
  { icon: Globe, title: "Turismo & Hospitalidad", desc: "Marketing digital especializado para hoteles, tours y experiencias en Playa del Carmen y la Riviera Maya. SEO local, Google Ads y estrategias de temporada para atraer turistas nacionales e internacionales." },
  { icon: ShoppingCart, title: "Restaurantes & Gastronomía", desc: "Estrategias de visibilidad local para restaurantes en Quinta Avenida, Playacar y alrededores. Google Business, redes sociales y campañas de temporada." },
  { icon: FileText, title: "Bienes Raíces", desc: "Lead generation para desarrolladoras y agencias inmobiliarias en Playa del Carmen y Playacar con campañas de alta intención y landing pages especializadas." },
  { icon: Users, title: "Servicios Profesionales", desc: "SEO local, Google Ads y landing pages especializadas para firmas de consultoría, legal y servicios técnicos en Playa del Carmen." },
  { icon: PieChart, title: "Startups & Scale-ups", desc: "Validación rápida de canales, unit economics y frameworks de growth para startups en Playa del Carmen y el Caribe Mexicano." },
  { icon: BarChart3, title: "Comercio & Retail", desc: "Estrategias de marketing digital para comercios locales y franquicias con presencia en Playa del Carmen, Cancún y Tulum." },
];

const localAreas = [
  { name: "Playa del Carmen", desc: "Agencia de marketing digital en Playa del Carmen enfocada en crecimiento empresarial, SEO local, generación de leads y campañas de alto rendimiento para negocios en Quinta Avenida, Playacar y alrededores." },
  { name: "Cancún", desc: "Servicios de marketing digital para empresas en Cancún. Estrategias de posicionamiento, Google Ads y automatización comercial para negocios en la zona hotelera, centro y Puerto Cancún." },
...
const faqs = [
  {
    ...
    a: "Sí. Somos una agencia de marketing digital con amplia experiencia en Playa del Carmen. Diseñamos estrategias de SEO local, Google Ads, automatización de leads y analítica avanzada adaptadas al mercado de la zona.",
  },
  {
    q: "¿Qué incluye el servicio de marketing digital en Playa del Carmen?",
    a: "Nuestro servicio incluye SEO técnico y local, campañas de Google Ads, landing pages de conversión, email marketing, analítica avanzada con GA4 y CRO. Todo orientado a generar leads cualificados y escalar ingresos para negocios locales.",
  },
  {
    q: "¿Trabajan con restaurantes y negocios turísticos en Playa del Carmen?",
    a: "Absolutamente. Tenemos experiencia con restaurantes, hoteles, tours y servicios turísticos en Playa del Carmen. Diseñamos estrategias que conectan con audiencias locales e internacionales durante todo el año.",
  },
  {
    q: "¿También cubren Cancún y Tulum?",
    a: "Sí. Brindamos cobertura de marketing digital en toda la Riviera Maya: Playa del Carmen, Cancún, Tulum, Puerto Morelos, Akumal y Puerto Aventuras. Adaptamos cada estrategia al mercado y la audiencia de cada zona.",
  },
  {
...
/* ─── Main Page ─── */
const MarketingDigitalPlayaDelCarmenPage = () => {
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          <motion.div {...fade()} className="text-center mb-12">
            ...
            <h2 className="text-2xl sm:text-3xl font-extrabold font-display mb-3">
              Marketing Digital en Playa del Carmen y{" "}
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          <motion.div {...fade()} className="text-center mb-14">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold font-display mb-4">
              Servicios de Marketing <span className="gradient-text">Digital en Playa del Carmen</span>
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Cada canal está diseñado para generar tráfico cualificado, leads y revenue medible para negocios en Playa del Carmen, Tulum y la Riviera Maya.
            </p>
          </motion.div>
          ...
          <motion.div {...fade(0.4)} className="mt-4 text-center">
            <div className="flex flex-wrap justify-center gap-3">
              ...
              <span className="text-muted-foreground/30">·</span>
              <Link to="/marketing-digital-tulum" className="text-sm text-muted-foreground hover:text-primary underline underline-offset-4 transition-colors">
                Marketing digital en Tulum
              </Link>
            </div>
          </motion.div>
        </div>
      ...
      <section className="py-24 surface-sunken relative">
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          <motion.div {...fade()} className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Un sistema probado de cuatro fases para escalar negocios en Playa del Carmen, Tulum y la Riviera Maya.
            </p>
          </motion.div>
      ...
      <section className="py-14 relative overflow-hidden border-y border-border/10">
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10 mb-6">
          <p className="text-center text-[10px] text-muted-foreground tracking-[0.25em] uppercase font-medium">
            Tecnologías y plataformas que utilizamos para marketing digital en Playa del Carmen y Riviera Maya
          </p>
        </div>
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10 text-center max-w-3xl">
          <motion.div {...fade()}>
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-white/10 bg-white/5 text-xs text-white/50 mb-6 backdrop-blur-sm">
              <span className="w-2 h-2 rounded-full bg-primary animate-status-pulse" />
              Marketing Digital Playa del Carmen
            </div>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold font-display mb-6 text-white leading-tight">
              ...
              <span className="gradient-text">en Playa del Carmen</span>
            </h2>
            <p className="text-base sm:text-lg text-white/50 mb-10 max-w-xl mx-auto leading-relaxed">
              Combinamos conocimiento local con estrategias de clase mundial para ayudarte a dominar el mercado de Playa del Carmen, Tulum y toda la Riviera Maya.
            </p>
      ...
      <section className="py-24 relative">
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          <motion.div {...fade()} className="text-center mb-14">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold font-display mb-4">
              Métricas que <span className="gradient-text">optimizamos</span> en Playa del Carmen
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Nos enfocamos en los indicadores que realmente impactan el crecimiento y la rentabilidad de tu negocio en Playa del Carmen y la Riviera Maya.
            </p>
          </motion.div>
      ...
      <section className="py-24 surface-sunken relative">
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          <motion.div {...fade()} className="text-center mb-14">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold font-display mb-4">
              Marketing digital para <span className="gradient-text">tu industria en Playa del Carmen</span>
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Estrategias de marketing digital especializadas por vertical para empresas en Playa del Carmen, Tulum y la Riviera Maya.
            </p>
          </motion.div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {useCases.map((u, i) => (
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10 max-w-3xl">
          <motion.div {...fade()} className="text-center mb-12">
            ...
            <h2 className="text-2xl sm:text-3xl font-extrabold font-display mb-3">
              ...
              <span className="gradient-text">Playa del Carmen</span>
            </h2>
          </motion.div>
          <motion.div {...fade(0.1)}>
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10 text-center max-w-3xl">
          <motion.div {...fade()}>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold font-display mb-6 text-white">
              Escala tu negocio en Playa del Carmen con{" "}
              <span className="gradient-text">marketing digital</span>
            </h2>
            <p className="text-lg text-white/60 mb-10 max-w-xl mx-auto">
              La agencia de marketing digital en Playa del Carmen y Riviera Maya que combina datos, tecnología y creatividad para generar resultados medibles.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <Button variant="gradient" size="lg" asChild>
...
export default MarketingDigitalPlayaDelCarmenPage;
